...
const PastEventDashboard =()=>{
    ...
    const mydata = async () => {
      try{
      const response = await axios.get(`http://its-rgpv-backend.vercel.app/PastEvent/${id}`);
                      ...
                      <tbody className="bg-gray-800">
                        <tr className="bg-black bg-opacity-20">
                          ...
                          <button style={{padding:'5px'}} onClick={async()=>{
                            ...
                            await axios.delete(`http://its-rgpv-backend.vercel.app/PastEvent/${Personaldata.Rid}`);
