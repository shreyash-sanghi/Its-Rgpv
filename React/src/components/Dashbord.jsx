...
const Dashbord = () => {
  ...
  const mydata = async () => {
    try {
      ...
      const response = await axios.get(`http://its-rgpv-backend.vercel.app/Dashbord/${id}`);
                          ...
                          <tbody className="bg-gray-800">
                            <tr className="bg-black bg-opacity-20">
                              ...
                              <td className="flex px-6 py-4 whitespace-nowrap">
                                ...
                                try{
                                    if(con === true){
                                  await axios.delete(`http://its-rgpv-backend.vercel.app/Dashbord/${Personaldata.Rid}`);
