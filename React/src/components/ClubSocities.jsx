  ...
  return (
    ...
    <Navbar/>
          ...
          <div className="flex flex-wrap -m-4">
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="club-cards p-6">
                <img
                  className="h-14 rounded w-full object-contain object-center mb-6"
                  src={phoenixlogo}
                  alt="content"
                />
                ...
                <h2 className="text-lg  font-medium mb-1 mt-1">Team Phoenix</h2>
            ...
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="club-cards  p-6">
                ...
                <h2 className="text-lg  font-medium mb-1 mt-1">Team E-Cell</h2>
                <p className="text-sm text-gray-300">
            ...
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="club-cards  p-6">
                ...
                <h2 className="text-lg  font-medium mb-1 mt-1">The Devoic</h2>
                <p className="text-sm text-gray-300">
            ...
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="club-cards  p-6">
                ...
                <h2 className="text-lg  font-medium mb-1 mt-1">Team GDSC</h2>
                <p className="text-sm text-gray-300">
          ...
          <div className="flex flex-wrap -m-4">
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="club-cards p-6">
                ...
                <h2 className="text-lg  font-medium mb-1 mt-1">Team Code4all</h2>
                <p className="text-sm text-gray-300">
            ...
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="club-cards mix-blend-difference p-6">
                <img
                  className="h-14 rounded w-full object-contain mix-blend-multiply object-center mb-6"
                  src={fclogo}
                  alt="content"
                />
                <h3 className="tracking-widest text-xs font-medium title-font">
                ...
                <h2 className="text-lg  font-medium mb-1 mt-1">Friday Colours</h2>
                <p className="text-sm text-gray-300">
            ...
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="club-cards  p-6">
                ...
                <h2 className="text-lg  font-medium mb-1 mt-1">Team Insync</h2>
                <p className="text-sm text-gray-300">
            ...
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="club-cards  p-6">
                <img
                  className="h-14 rounded w-full object-contain object-center mix-blend-difference mb-6"
                  src={codingclublogo}
                  alt="content"
                />
                <h3 className="tracking-widest text-xs font-medium title-font">
                ...
                <h2 className="text-lg  font-medium mb-1 mt-1 ">
                  Autotelic Society
                </h2>
                <p className="text-sm text-gray-300">
      ...
      <div className="flex items-center justify-center">
        <div className="grid grid-cols-2 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
          <div className="relative py-6 sm:px-6 rounded-3xl club-cards w-56 sm:w-64 my-4 shadow-xl">
          ...
          <div className="relative py-6 px-2 sm:px-6 club-cards rounded-3xl w-56 sm:w-64 my-4 shadow-xl">
          ...
          <div className="relative  py-6 px-6 rounded-3xl w-64 my-4 club-cards shadow-xl">
            ...
            <div className="mt-8">
              <p className="text-xl font-semibold my-2">Algozenith UIT-Rgpv</p>
              <div className="flex space-x-2 text-gray-400 text-sm">
                <p>
