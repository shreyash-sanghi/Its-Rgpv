...
const VarifyEvent = () => {
    ...
    const getdata = async () => {
        const response = await axios.get(`${process.env.Server_Path}/VerifyEvent/${id}`);
    ...
    const PostEvent = async(e)=>{
        ...
        const responce = await axios.post(`${process.env.Server_Path}/VerifyEvent/${id}`,{
            EventName,Discreption,Place,EDate,Time,Name,RegLink,Image, ReqEmail
        })
           await axios.delete(`${process.env.Server_Path}/Request/${id}`);
            ...
            >
              ...
              <div className="relative z-0 w-full mb-6 group">
                ...
                <div className="grid md:grid-cols-2 md:gap-6">
                   ...
                   <img  src={`${process.env.Server_Path}/images/`+ini.Image} className="w-[13rem] h-[12rem]"/> </div>
                   </div>
                <div className="grid md:grid-cols-2 md:gap-6">
                    <div className="relative z-0 w-full mb-6 group">
                        <input
                ...
                <button id="deletebutton" className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800" onClick={async () => {
                                  const response = await axios.delete(`${process.env.Server_Path}/Request/${id}`);
