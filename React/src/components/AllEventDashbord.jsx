...
const AllEventDashbord =()=>{
    ...
    const mydata = async () => {
      try {
        ...
        const response = await axios.get(`http://127.0.0.1:4000/AllEventDashbord/${id}`);
                    ...
                    <table className=" text-sm text-gray-400">
                      ...
                      <tbody className="bg-gray-800">
                        <tr className="bg-black bg-opacity-20">
                          ...
                          <img  src={`http://127.0.0.1:4000/images/`+Personaldata.EventBanner} className="w-20 h-10"/>
                            </td>
                          ...
                          <button style={{padding:'5px'}} onClick={async()=>{
                            ...
                            await axios.delete(`http://127.0.0.1:4000/PersonalPage/${Personaldata.Rid}`);
