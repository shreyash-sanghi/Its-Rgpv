...
const AllEventDashbord =()=>{
    ...
    const mydata = async () => {
      try {
        ...
        const response = await axios.get(`http://its-rgpv-backend.vercel.app/AllEventDashbord/${id}`);
                    ...
                    <table className=" text-sm text-gray-400">
                      ...
                      <tbody className="bg-gray-800">
                        <tr className="bg-black bg-opacity-20">
                          ...
                          <img  src={`http://its-rgpv-backend.vercel.app/images/`+Personaldata.EventBanner} className="w-20 h-10"/>
                            </td>
                          ...
                          <button style={{padding:'5px'}} onClick={async()=>{
                            ...
                            await axios.delete(`http://its-rgpv-backend.vercel.app/PersonalPage/${Personaldata.Rid}`);
