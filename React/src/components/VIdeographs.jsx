...
const VIdeographs = () => {
  return (
    <>
      <div className="container my-0 mx-auto md:px-24">
        <section className="">
          <div className="mb-16 flex flex-wrap">
            <div className="mb-6  w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-2/5 lg:pr-6">
            ...
            <div className="w-full video-bg pr-8 rounded-xl shrink-0 grow-0 basis-auto lg:w-3/5 lg:pl-6">
              <h3 className="mb-2 pt-4 text-2xl font-bold">
          ...
          <div className="mb-16 flex flex-wrap lg:flex-row-reverse">
            <div className="mb-6 w-full  shrink-0 grow-0 basis-auto lg:mb-0 lg:w-2/5 lg:pl-6">
              <div className=" relative overflow-hidden rounded-lg">
                <video
                  src={mahavideo}
                  controls
            ...
            <div className="w-full video-bg pl-8 rounded-xl shrink-0 grow-0 basis-auto lg:w-3/5 lg:pr-6">
              <h3 className="mb-2 pt-4 text-2xl font-bold">
              ...
              <p className="text-neutral-500 pb-4 dark:text-neutral-300">
          ...
          <div className="flex flex-wrap">
            <div className="mb-6 w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-2/5 lg:pr-6">
              <div className="ripple relative overflow-hidden rounded-lg">
                <video
                  src={vijayvideo}
                  controls
                  poster={coverimg3}
            ...
            <div className="w-full video-bg pl-8 rounded-xl shrink-0 grow-0 basis-auto lg:w-3/5 lg:pl-6">
              <h3 className="mb-3 pt-4 text-2xl font-bold">Vijay Path 2023</h3>
              <p className="mb-2 text-sm text-neutral-500 dark:text-neutral-400">
                Host : Civil Department ❤️
              </p>
              <p className="text-neutral-500 pb-4 pr-8 dark:text-neutral-300">
              Shankhnaad, the crown jewel of RGPV's cultural calendar,
                orchestrates an annual symphony of creativity and camaraderie.
                This grand festival, anchored in the spirit of promoting the
                Hindi language, unfolds a magnificent spectrum of events
