...
const PersonalPage = () => {
  ...
  const getdata = async () => {
    try {
      ...
      const response = await Axios.get(`https://its-rgpv-nmum.vercel.app/PersonalPage/${id}`,
      {
        withCredentials: true,
        credentials: 'include',
        headers: {
          'Access-Control-Allow-Origin': `https://its-rgpv-nmum.vercel.app`,
                      ...
                      <tbody className="bg-gray-800">
                        <tr className="bg-black bg-opacity-20">
                          ...
                          const con =  confirm("You have conform delete a event... ");
                           try {
                            if(con === true){
                            await Axios.delete(`https://its-rgpv-nmum.vercel.app/PersonalPage/${info.id}`);
