...
const Update = () => {
  ...
  const allupdate = async () => {
    ...
    try {
      const response = await axios.get(`http://its-rgpv-backend.vercel.app/PastEvent/${token}`);
        ...
        return (
          <>
              ...
              <div className="max-w-2xl mt-4 h-auto mx-auto p-4 sm:px-6 border-4 border-white ">
                <article 
                className=" max-w-[22rem] mx-auto md:max-w-none grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 xl:gap-16 items-center">
                  <figure
                  ...
                  >
                    ...
                    className="h-[17rem] md:h-72 "
                      ...
                      src={`http://its-rgpv-backend.vercel.app/images/`+info.Image}
                      width="540"
                      height="303"
                      alt="Blog post"
                    />
                  ...
                  <div>
                    ...
                    <p className="text-sm pt-1 text-blue-400 flex-grow">
                      Venue : {info.Place}
                    </p>
