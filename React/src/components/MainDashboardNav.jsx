...
const MainDashboardNav = ()=>{
    ...
    return(
    <>   
       <div className="p-3 space-y-2 dark:bg-gray-900  w-[26%] sm:w-[21%] lg:w-1/6">
          <div className="flex items-center p-2 space-x-4">
            <img
              ...
              alt=""
              className="w-12 h-12 hidden xlg:block rounded-full dark:bg-gray-500"
            />
            <div>
            ...
            <ul className="pt-2 pb-4 space-y-1  text-sm">
              <li className="dark:text-gray-50">
                <a
                  rel="noopener noreferrer"
                  href="#"
                  className="flex items-center p-2 space-x-3 rounded-md  focus:bg-gray-800"
                >
                  <svg
                  ...
                  >
                   ...
                   <Link to={`/maindashboard/${id}`} className=' focus:bg-gray-800' >Event Requests</Link>
                </a>
              </li>
              <li>
                <Link
                ...
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    className="w-5 h-5 fill-current hidden sm:flex dark:text-gray-400"
                  >
                    <path d="M479.6,399.716l-81.084-81.084-62.368-25.767A175.014,175.014,0,0,0,368,192c0-97.047-78.953-176-176-176S16,94.953,16,192,94.953,368,192,368a175.034,175.034,0,0,0,101.619-32.377l25.7,62.2L400.4,478.911a56,56,0,1,0,79.2-79.195ZM48,192c0-79.4,64.6-144,144-144s144,64.6,144,144S271.4,336,192,336,48,271.4,48,192ZM456.971,456.284a24.028,24.028,0,0,1-33.942,0l-76.572-76.572-23.894-57.835L380.4,345.771l76.573,76.572A24.028,24.028,0,0,1,456.971,456.284Z"></path>
                  </svg>
                  <span >New Club Register</span>
                </Link>
              </li>
              <li>
                <Link
                ...
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    className="hidden sm:flex w-5 h-5 fill-current dark:text-gray-400  focus:bg-gray-800"
                  >
              ...
              <li>
                ...
                >
                  ...
                  <NavLink to={`/ComplaintDashboard/${id}`}>
                    Complaint
                  </NavLink>
                </a>
              </li>
