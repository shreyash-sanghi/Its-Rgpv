...
const NotesCTA = () => {
  return (
    ...
    <main className="flex mb-0 flex-1 w-full flex-col items-center justify-center text-center px-4 sm:mt-12 mt-20">
      ...
      <section className="">
  <div className="container my-10 mx-auto px-10 md:px-24">
    <div className="lg:w-3/3 flex flex-col sm:flex-row sm:items-center items-start mx-auto">
      <h1 className="flex-grow sm:pr-16 text-xl font-medium title-font ">
      ...
      <a href='https://www.rgpvnotes.in/btech/grading-system-old/notes/' target='blank' className="flex-shrink-0 text-white bg-purple-700 border-0 py-2 px-8 focus:outline-none hover:bg-purple-600 rounded text-lg mt-10 sm:mt-0">Notes</a>
    </div>
  </div>
</section>
    </>
