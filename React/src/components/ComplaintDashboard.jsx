...
const ComplaintDashboard = () => {
    ...
    const getdata = async()=>{
        try{
        const response = await axios.get(`https://its-rgpv-nmum.vercel.app/Complaint/${id}`);
            ...
            <div className="flex w-full justify-between">
                ...
                <div className="w-5/6  justify-center items-center">
                    <div className="flex flex-col items-center  py-10">
                        <h1 className="text-lg text-gray-100 font-medium">
                            Complaint Dashboard
                        </h1>
                        ...
                        return(
                        <div ref={pdfRef}
                            className="h-fit mx-2 max-w-[20rem] sm:max-w-xl mt-5 md:mt-10 block rounded-lg bg-white text-center shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                            <div className="flex flex-col sm:flex-row justify-between ">                           
                            <div
                                className="text-black border-b-2 border-neutral-100 px-6 py-3 dark:border-neutral-600 dark:text-neutral-50">
                              Name :-  {info.Name}    
                            </div>
                            <div
                                className="text-black border-b-2 border-neutral-100 px-6 py-3 dark:border-neutral-600 dark:text-neutral-50">
                            ...
                            <div
                                className=" text-black border-t-2 border-neutral-100 px-6 py-3 dark:border-neutral-600 dark:text-neutral-50">
                                {info.PostDate}
                            </div>
                            ...
                            onClick={async()=>{
                                ...
                                await axios.delete(`https://its-rgpv-nmum.vercel.app/Complaint/${info.Did}`);
